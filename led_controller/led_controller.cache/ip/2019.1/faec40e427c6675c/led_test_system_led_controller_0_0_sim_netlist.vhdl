...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_led_controller_v1_0_S00_AXI is
  ...
  signal slv_reg0 : STD_LOGIC_VECTOR ( 14 downto 0 );
  ...
  attribute SOFT_HLUTNM of \max[0]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \max[1]_i_1\ : label is "soft_lutpair3";
...
\max[3]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
\max[3]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\max[3]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
\max[3]_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
led_controller_v1_0_S00_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_led_controller_v1_0_S00_AXI
     port map (
      LEDs_out(3 downto 0) => Q(3 downto 0),
      S_AXI_ARREADY => S_AXI_ARREADY,
      S_AXI_AWREADY => S_AXI_AWREADY,
      S_AXI_WREADY => S_AXI_WREADY,
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_led_controller_v1_0
     port map (
      Q(3 downto 0) => LEDs_out(3 downto 0),
